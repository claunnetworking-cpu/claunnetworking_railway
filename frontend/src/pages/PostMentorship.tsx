...
export default function PostMentorship() {
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Compartilhe sua experiência e mentorize profissionais em desenvolvimento.
          </p>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
            ...
            <p className="text-blue-800">
              Este módulo será implementado em breve. Você poderá criar e gerenciar suas mentorías de forma simples e intuitiva.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <ul className="space-y-2 text-gray-700">
                <li>✓ Criar e publicar mentorías</li>
                <li>✓ Gerenciar mentorados</li>
